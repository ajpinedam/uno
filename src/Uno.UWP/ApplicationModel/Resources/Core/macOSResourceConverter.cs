...
namespace Windows.ApplicationModel.Resources.Core
{
	...
	/// </summary>
	internal class macOSResourceConverter
	{
		public static string Convert(ResourceCandidate resourceCandidate, string defaultLanguage)
		{
			...
			{
				ex.Log().Info($"Couldn't convert {resourceCandidate.ValueAsString} to an macOS resource path.", ex);
				return null;
			}
		}
